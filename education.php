 ...
 <?php
	...
	<?php }else{
		...
		<tr>
		  ...
		  <td><a href="corephp/deleteedu.php?id=<?php echo $resu['id'];?>" onclick="return confirm('Are you sure you want to Delete?');" class="btn btn-danger">Delete</a>
		  </td>
		</tr>
	<?php }}?>
...
<div class="container"> 
	<div class="from-inner eidtpage"> 
		<form action="corephp/addeducation.php" method="post">
