...
<div class="otersection">
	...
	<div class="row">
		<div class="col clearfix">
		   ...
		   <div class="link float-right"><a href="editprofile.php?email=<?php echo $email ;?>">Edit</a></div>
		</div>
	</div>	   
</div>
...
<div class="top">
	<div class="row">
		<div class="col clearfix">
		   <div class="float-left"><h3>Guardian  Info</h3></div>
		   <div class="link float-right"><a href="guardian.php?email=<?php echo $email ;?>">Edit</a></div>
		</div>
	</div>	   
</div>
...
<div class="top">
	<div class="row">
		<div class="col clearfix">
		   <div class="float-left"><h3>Present Address</h3></div>
		   <div class="link float-right"><a href="presentadd.php?email=<?php echo $email ;?>">Edit</a></div>
		</div>
	</div>	   
</div>
...
<div class="top">
	<div class="row">
		<div class="col clearfix">
		   <div class="float-left"><h3>Permanent Address</h3></div>
		   <div class="link float-right"><a href="permanent.php?email=<?php echo $email ;?>">Edit</a></div>
		</div>
	</div>	   
</div>
...
<div class="top">
	<div class="row">
		<div class="col clearfix">
		   <div class="float-left"><h3>Education and Training</h3></div>
		   <div class="link float-right"><a href="education.php?email=<?php echo $email ;?>">Edit</a></div>
		</div>
	</div>	   
</div>
