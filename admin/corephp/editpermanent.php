...
if(isset($_REQUEST['submit'])){
		...
		if( $Address=="" || $PostOffice=="" || $PoliceStation=="" || $DistrictCity=="" || $DivisionState=="" || $Country=="" || $ZipCode==""){
			header("Location:../permanent.php?error=Field Must Not Be Empty!!!&email=$email");
		}else{
		...
		if($run== true){
			header("Location:../permanent.php?msg=Data Updated Successfully.&email=$email");
		}else{
			header("Location:../permanent.php?error=Something Went Wrong.&email=$email");
		}
